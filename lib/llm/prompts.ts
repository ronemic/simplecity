...
- Treat text explicitly labeled as meeting-wide participation context as shared evidence for every card's “commentWindow” and “howToAct” fields. Do not use that shared text for item-specific facts or status.
