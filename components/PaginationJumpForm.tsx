...
export function PaginationJumpForm({
  ...
  return (
    <form
      className="flex flex-wrap items-center justify-center gap-2 text-sm font-bold text-slate"
    ...
    >
      <label className="inline-flex items-center gap-2">
        ...
        <input
          ...
          className="h-9 w-16 rounded-lg border border-rule bg-surface px-2 text-center text-sm font-semibold text-ink shadow-sm focus:border-brand focus:outline-none focus:ring-4 focus:ring-brand/15"
          inputMode="numeric"
          max={pageCount}
          min={1}
